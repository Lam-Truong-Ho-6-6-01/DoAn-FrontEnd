  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img src="https://iconape.com/wp-content/png_logo_vector/%D8%A5%D9%84-%D8%AA%D9%8A-lt.png" alt="Yame.vn"
          style="width: 66px;">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <router-link to="/" class="nav-link hover" aria-current="page">
              TRANG CHỦ
            </router-link>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle hover" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              THIẾT KẾ NĂNG ĐỘNG - KÍN ĐÁO
            </a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="#ao">Áo năng động</a></li>
              <li><a class="dropdown-item" href="#ao">Áo kính đáo</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="#balo">Balo</a></li>
              <li><a class="dropdown-item" href="#giay">Giày</a></li>
            </ul>
          </li>
        </ul>
